...
EXTERNAL NAME [Smarty.Plugins.SqlServer].[SmartySqlServerPlugin.USStreetApi].[SmartyUSStreetVerifyFreeform]
GO
...
INSERT INTO freeform_results SELECT * FROM SmartyUSStreetVerifyFreeform('3214 N University Ave Provo UT 84604', 2, '', @AUTH_ID, @AUTH_TOKEN, @URL);
INSERT INTO freeform_results SELECT * FROM SmartyUSStreetVerifyFreeform('1500 NE Miami Place Apt 202 Miami FL', 2, '', @AUTH_ID, @AUTH_TOKEN, @URL);
INSERT INTO freeform_results SELECT * FROM SmartyUSStreetVerifyFreeform('1109 9th Phoenix AZ', 2, '', @AUTH_ID, @AUTH_TOKEN, @URL);
INSERT INTO freeform_results SELECT * FROM SmartyUSStreetVerifyFreeform('121 E Victory Rd PO Box 101 Meridian, ID', 2, '', @AUTH_ID, @AUTH_TOKEN, @URL);
INSERT INTO freeform_results SELECT * FROM SmartyUSStreetVerifyFreeform('1 Rosedale Baltimore MD', 2, '', @AUTH_ID, @AUTH_TOKEN, @URL);
INSERT INTO freeform_results SELECT * FROM SmartyUSStreetVerifyFreeform('1042 W Center St Apt A Orem UT', 2, '', @AUTH_ID, @AUTH_TOKEN, @URL);
INSERT INTO freeform_results SELECT * FROM SmartyUSStreetVerifyFreeform('3214 N University Ave Provo UT 84604', 2, '', '', '', @URL);
INSERT INTO freeform_results SELECT * FROM SmartyUSStreetVerifyFreeform('3215 N University Ave Provo UT 84604', 2, '', @AUTH_ID, @AUTH_TOKEN, @URL);
INSERT INTO freeform_results SELECT * FROM SmartyUSStreetVerifyFreeform('', 2, '', @AUTH_ID, @AUTH_TOKEN, @URL);

SELECT * from freeform_results;

DROP FUNCTION [dbo].[SmartyUSStreetVerifyFreeform]
GO
